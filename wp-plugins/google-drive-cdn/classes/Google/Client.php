...
require_once WPB_GOOGLE_INC.'Google/Auth/AssertionCredentials.php';
require_once WPB_GOOGLE_INC.'Google/Cache/File.php';
require_once WPB_GOOGLE_INC.'Google/Cache/Memcache.php';
require_once WPB_GOOGLE_INC.'Google/Config.php';
require_once WPB_GOOGLE_INC.'Google/Collection.php';
require_once WPB_GOOGLE_INC.'Google/Exception.php';
require_once WPB_GOOGLE_INC.'Google/IO/Curl.php';
require_once WPB_GOOGLE_INC.'Google/IO/Stream.php';
require_once WPB_GOOGLE_INC.'Google/Model.php';
require_once WPB_GOOGLE_INC.'Google/Service.php';
require_once WPB_GOOGLE_INC.'Google/Service/Resource.php';
